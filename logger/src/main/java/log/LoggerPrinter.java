...
final public class LoggerPrinter implements Printer {
   ...
   */
    static final int MIN_STACK_OFFSET = 3;
...
//    String tag = getTag();
    ...
    void logTopBorder(int logType, String tag) {
    logChunk(logType, tag, TOP_BORDER);
  }

  @SuppressWarnings("StringBufferReplaceableByString")
    void logHeaderContent(int logType, String tag, int methodCount) {
    ...
    void logBottomBorder(int logType, String tag) {
    logChunk(logType, tag, BOTTOM_BORDER);
  }

    void logDivider(int logType, String tag) {
    logChunk(logType, tag, MIDDLE_BORDER);
  }

    void logContent(int logType, String tag, String chunk) {
    ...
    void logChunk(int logType, String tag, String chunk) {
   ...
   */
    int getStackOffset(StackTraceElement[] trace) {
